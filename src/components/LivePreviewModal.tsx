...
function buildEnhancedHtml(
  ...
  // Build addon sections - only those with visual representations
  ...
  // Script to fix anchor navigation inside iframe
  const anchorFixScript = `
    <script>
      document.addEventListener('DOMContentLoaded', function() {
        // Fix all anchor links to scroll smoothly within the iframe
  ...
  // Insert addon sections seamlessly before footer/</body>
  // Try to insert before <footer> first, then before </body>
  ...
  // Add animations and anchor fix script before </body>
...
export default function LivePreviewModal({
  ...
  const enhancedHtml = buildEnhancedHtml(htmlContent, allAddons, selectedAddonIds);
